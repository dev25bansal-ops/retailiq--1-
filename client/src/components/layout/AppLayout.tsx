...
const AppLayout: React.FC<AppLayoutProps> = ({
  ...
  const consumerBottomNavItems = [
    ...
    { label: 'AI Intel', path: '/consumer/predictive', icon: <AutoAwesomeIcon /> },
  ...
  const msmeBottomNavItems = [
    ...
    { label: 'AI Intel', path: '/msme/predictive', icon: <AutoAwesomeIcon /> },
    { label: 'Intel', path: '/msme/competitive', icon: <QueryStatsIcon /> },
    { label: 'Inventory', path: '/msme/inventory', icon: <InventoryIcon /> },
  ];
